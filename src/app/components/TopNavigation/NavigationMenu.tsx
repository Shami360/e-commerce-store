...
const NavigationMenu = () => {
  return (
    ...
    <div className="flex justify-between items-center">
     ...
     <Link href={'/Products'}><p className="text-[#726E8D] text-[16px] font-normal  hover:scale-105 transition-all duration-300">Tables</p></Link>
     <Link href={'/Cart'}><p className="text-[#726E8D] text-[16px] font-normal  hover:scale-105 transition-all duration-300">Chairs</p></Link>
