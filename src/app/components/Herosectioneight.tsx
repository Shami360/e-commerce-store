...
import { fetchProducts, fetchSingleProduct } from "@/services/product";
import { ProductType } from "@/types/product";
export default async function Herosectioneight(){
    const dynamicProducts =  await fetchProducts();
    // const product = await fetchSingleProduct('product-1');
    // console.log(product);
    const products = [
        {
          id: 1,
        ...
        <section className="bg-white py-16">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              { dynamicProducts  == null ? products.map((product) => (
              ...
              )): dynamicProducts.map((product:ProductType) => (
